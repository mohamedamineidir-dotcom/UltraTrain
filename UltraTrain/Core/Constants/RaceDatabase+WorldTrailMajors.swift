...
extension RaceDatabase {
    ...
    static let worldTrailMajors: [KnownRace] = [
        ...
        KnownRace(name: "Trail 100 Andorra Ultra 105K", shortName: nil,
                  ...
                  gpxAssetName: "trail100andorra-105k"),
